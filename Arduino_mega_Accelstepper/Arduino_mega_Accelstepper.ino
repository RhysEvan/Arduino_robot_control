...
void setup() {
  steppers[0] = newStepper(26,28,24, 2000, 1500);
  steppers[1] = newStepper(32,47,45, 2000, 1500);
  steppers[2] = newStepper(36,34,30, 2000, 1500);
  steppers[3] = newStepper(54,55,38, 2000, 1500);
  steppers[4] = newStepper(60,61,56, 2000, 1500);
  steppers[5] = newStepper(46,48,62, 2000, 1500);
